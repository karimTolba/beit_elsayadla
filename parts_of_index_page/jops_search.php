...
<div id="form_container" style="margin : 50px auto <?php if(!empty($_SESSION["results"]) || !empty($_SESSION["no_results"])) echo "50px"; else echo "100px"; ?> auto;">
  <form action="handles/jop_res_handle.php" method="post" dir="rtl" style="text-align : right;">
          ...
          <div class="card col-lg-5 col-sm-12" style="width: 18rem;background-color : black;color : green;border-radius : 10px;margin-top : 20px;margin-bottom : 20px;">
            <a href=<?php $id = $results_arr[$i_1][$i_2]["id"]; $place = "parts_of_index_page/jop_details.php";$title="تفاصيل%20الوظيفة"; echo "?title=" .$title."&place=" .$place."&id=".$id; ?>>
              <div class="card-body">
                ...
                <p class="card-text" style="text-align: right;"><?php echo utf8_decode($results_arr[$i_1][$i_2]["exp_not"]); ?></p>
              </div>
            </a>  
          </div> 
          <?php } ?>
        ...
        <div class="card col-lg-5 col-sm-12" style="width: 18rem;background-color : black;color : green;border-radius : 10px;margin-top : 20px;margin-bottom : 20px;">
            <a href=<?php $id = $result["id"]; $place = "parts_of_index_page/jop_details.php";$title="تفاصيل%20الوظيفة"; echo "?title=" .$title."&place=" .$place."&id=".$id; ?>>
              <div class="card-body">
                ...
                <p class="card-text" style="text-align: right;"><?php echo utf8_decode($result["exp_not"]); ?></p>
              </div>
            </a>  
          </div> 
      <?php }?>  
