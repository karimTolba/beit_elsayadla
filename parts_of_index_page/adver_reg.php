...
<div id="form_container" style="margin : 50px auto 100px auto;">
  <form action="handles/adver_handle.php" method="post" enctype="multipart/form-data" dir="rtl" style="text-align : right;">
    ...
    <div class="form-group">
        <label for="exampleFormControlSelect1">المناطق*</label>
    ...
    <div class="form-group">
        <label for="area">ايجار/ بيع*</label>
        <select class="form-control" id="area" name="operation_name" required>
    ...
    <div class="input-group-prepend">
        <label for="news_image" style="margin-right : 10px;">*اختر الصورة</label>
